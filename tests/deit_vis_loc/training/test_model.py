...
def test_iter_triplets():
    ...
    triplets = ft.partial(model.iter_triplets, pos_fn, neg_fn)
...
def test_triplet_loss():
    ...
    l = ft.partial(model.triplet_loss, 0., lambda x: x)
    ...
    l = ft.partial(model.triplet_loss, .5, lambda x: x)
...
def test_early_stopping():
    ...
    it_learning = model.make_is_learning(2, 0)
